...
SIMPLE_HEADERS = (b'ACCEPT',
				  b'ACCEPT-LANGUAGE',
				  b'CONTENT-LANGUAGE',
				  b'LAST-EVENT-ID') #: HTTP request headers that `CORS`_ defines as "simple"
SIMPLE_CONTENT_TYPES = (b'application/x-www-form-urlencoded',
						b'multipart/form-data',
						b'text/plain') #: HTTP content types that `CORS`_ defines as "simple"
SIMPLE_RESPONSE_HEADERS = (b'cache-control',
						   b'content-language',
						   b'content-type',
						   b'expires',
						   b'last-modified',
						   b'pragma') #: HTTP response headers that `CORS`_ defines as simple
